...
const Navbar = ({ cartCount }) => {
  ...
  return (
    <nav className="navbar flex container mx-auto bg-base-100 shadow-md px-6 py-3 sticky top-0 z-50">
      <div className="">
        <button className="text-2xl font-bold" onClick={() => scrollTo("home")}>
          DigiTools
        </button>
      </div>
      <div className="">
